...
public sealed partial class GenerateAllTeachersExcelHandler
{
    ...
    public ValueTask Run(RunParams p)
    {
        ...
        void ConfigureMerges()
        {
            ...
            uint timeSlotCount = (uint) _timeConfig.TimeSlotCount;
        ...
        void Body()
        {
            ...
            for (int dayIndex = 0; dayIndex < 6; dayIndex++)
            {
                ...
                for (int timeSlotIndex = 0; timeSlotIndex < timeSlotCount; timeSlotIndex++)
                {
                    ...
                    bool isSeminarDate = day == seminarDate.Day && timeSlot == seminarDate.TimeSlot;
        ...
        {
            var firstId = Add(0);
            var timeSlotCount = _timeConfig.TimeSlotCount;
            ...
            SharedStringItemId Add(int timeSlotIndex)
            {
                ...
                var timeSlotString = _timeSlotDisplay.IntervalDisplay(interval);
